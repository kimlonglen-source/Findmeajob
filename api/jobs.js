module.exports = async function handler(req, res) {
  ...
  // Adzuna NZ redirect domains are legit NZ jobs
  // Any job redirect URL going to a .com domain (not .co.nz) that is NOT
  // an adzuna redirect is likely an overseas job scraped into NZ results
  function isNZJob(job) {
    ...
    // Adzuna's own redirect URLs are fine - they correctly tag NZ jobs
